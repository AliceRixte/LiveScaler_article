...
%TODO ajouter ref sur bref historique EDM, 
%TODO vérifier linear pitch space Composition With Pitch-Classes: A Theory of Compositional Design
%Robert D. Morris
...
%Commentaire 2 : 
% 1) Peut être que ce travail, en plus de proposer un système très intéressant, fait l'hypothèse/promeut plus généralement un renouvellement de la manière dont le publique apprécie des performances live. Si c'est le cas c'est ambitieux et ça mérite d'être mentionné.

% 2) D'ailleurs, est-il prévu d'inclure d'autres types de transformations ? Les transpositions diatoniques me semblent prometteuses dans le sens où elles permettent notamment la transformation modale mineur mélodique <-> majeur. Les inversions A<-1,x> définies dans l'espace diatonique peuvent aussi être très intéressantes.
