...
\begin{figure}[ht]
  ...
  \end{tikzpicture}
  \caption{La transformation $A \langle 1,2 \rangle : n \mapsto n + 2$  : transposition d'un ton vers l'aigu}\label{fig:transp}
\end{figure}
...
\begin{figure}[ht]
  ...
  \end{tikzpicture}   
  \caption{La transformation $A_{-1,4} :n\mapsto -n + 4$  : passage à la relative mineure de $C$ à $Am$\label{fig:inversion}}
  \medskip
  \small
...
Notre choix de nous restreindre aux transformations affines repose sur les faits suivants : \begin{itemize}
  \item on peut les appliquer à n'importe quel flux MIDI
  \item elles préservent les classes de hauteur 
  \item elles permettent d'exprimer des transformations souvent utilisées dans la musique occidentale : les transpositions, de passer d'une gamme mineure à une gamme majeure (et réciproquement), mais aussi de sortir de la tonalité passant de n'importe quelle gamme diatonique à une gamme par tons
\end{itemize} 
