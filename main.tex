...
Lorsque $\mu = 2$ ou $\mu = -2$, les transformations affines envoient n'importe quelle gamme vers une gamme apparentée à une gamme par tons. Contrairement aux inversions et aux transpositions, cette transformation n'est pas bijective. Les transformations affines peuvent donc permettre de sortir du cadre de la musique tonale occidentale.
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[baseline= (a).base]    
    ...
    \begin{tikzcd}[column sep=0pt, minimum width=11.5mm, row sep=0.1cm]
    % https://q.uiver.app/?q=
      {...}  & {G_0} & {G\sharp_0} & {A_{-1}} & {A\sharp_{-1}} & {B_{-1}} & {C_0} & {C\sharp_0} & {D_0} & {D\sharp_0} & {E_0} & {F_0} & {F\sharp_0}& {...} \\
  ...
  \end{tikzpicture}   
  \caption{La transformation $A_{2,0} :n\mapsto 2n$ permet d'obtenir des gammes apparentées à la gamme par tons.\label{fig:gammepartons}}
\end{figure}
...
\begin{table}[ht]
  \begin{subtable}[h]{0.45\textwidth}
    \centering % instead of \begin{center}
      \begin{tabular}{ccc}
          \writechord{C} & $\mapsto$ & \writechord{C}\\
          \writechord{D} & $\mapsto$ & \writechord{A\sharp}\\
          \writechord{E} & $\mapsto$ & \writechord{G\sharp}\\
          \writechord{F} & $\mapsto$ & \writechord{C\sharp}\\
          \writechord{G} & $\mapsto$ & \writechord{B}\\
          \writechord{A} & $\mapsto$ & \writechord{A}\\
          \writechord{B} & $\mapsto$ & \writechord{G}
      \end{tabular}
  \end{subtable}
  \begin{subtable}[h]{0.45\textwidth}
      \centering % instead of \begin{center}
...
\begin{table}[h]
  \begin{tabular}[cc]
    $\mu$ & Type de transformation & Nombre de classes de hauteur
    \hline
    -2 & Gamme par ton inversée & 6 
  ...
  \end{tabular}
  \caption{Classification des transformations affines selon leur coefficient modal $\mu$}
\end{table}
\end{comment}
