...
\begin{figure}[htbp]
  ...
  \end{tikzpicture}   
  \caption{La transformation $A\langle -1,4\rangle :n\mapsto -n + 4$ correspond au passage à la relative mineure de \writechord{Cma} à \writechord{Ami}\label{fig:inversion}}
  \medskip
  \small
